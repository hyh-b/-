...
public class AlbumController {
	...
	public ModelAndView login(HttpServletRequest request) {
		...
		ModelAndView modelAndView = new ModelAndView();
		modelAndView.setViewName("board_login");
		return modelAndView;
	}
	...
	public ModelAndView login_ok(HttpServletRequest request) {
		...
		ModelAndView modelAndView = new ModelAndView();
		modelAndView.setViewName("board_login_ok");
		return modelAndView;
	}
	
	@RequestMapping("/kakao_login")
	public ModelAndView kakao(HttpServletRequest request) {
	...
	public ModelAndView kakaodo(HttpServletRequest request) {
